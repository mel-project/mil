    ...
    fn expand_mangle_fns(&self, expr: &Expr, mangler: &mut LinearMangler) -> Result<UnrolledExpr, ParseErr>
    {
        match expr {
            ...
            Expr::BuiltIn(b) => match &**b {
                ...
                BuiltIn::BitAnd(e1,e2) => self.expand_binop(e1, e2, ExpandedBuiltIn::<UnrolledExpr>::BitAnd, mangler),
                BuiltIn::BitOr(e1,e2) => self.expand_binop(e1, e2, ExpandedBuiltIn::<UnrolledExpr>::BitOr, mangler),
                BuiltIn::BitXor(e1,e2) => self.expand_binop(e1, e2, ExpandedBuiltIn::<UnrolledExpr>::BitXor, mangler),

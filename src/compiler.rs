...
impl<T: Compile> Compile for ExpandedBuiltIn<T> {
    fn compile_onto(&self, b: BinCode) -> BinCode {
        match self {
            ...
            ExpandedBuiltIn::Shl(e1,e2) => compile_op(b, 0x60, vec![e1,e2]),
            ExpandedBuiltIn::Shr(e1,e2) => compile_op(b, 0x61, vec![e1,e2]),
            ExpandedBuiltIn::BitAnd(e1,e2) => compile_op(b, 0x62, vec![e1,e2]),
            ExpandedBuiltIn::BitOr(e1,e2) => compile_op(b, 0x63, vec![e1,e2]),
            ExpandedBuiltIn::BitXor(e1,e2) => compile_op(b, 0x64, vec![e1,e2]),
